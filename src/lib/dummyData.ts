...
export const CATEGORIES = [
  ...
  { id: "electronics", name: "Electronics", icon: "Laptop", count: 5 },
  { id: "fashion", name: "Fashion", icon: "Shirt", count: 3 },
  { id: "shoes", name: "Shoes", icon: "Footprints", count: 3 },
  { id: "home", name: "Home & Living", icon: "Home", count: 3 },
  { id: "beauty", name: "Beauty", icon: "Sparkles", count: 2 },
  { id: "sports", name: "Sports & Outdoors", icon: "Dumbbell", count: 2 },
  { id: "books", name: "Books", icon: "BookOpen", count: 1 },
...
export const TESTIMONIALS = [
  {
    ...
    rating: 5,
    comment: "The MacBook Pro M3 was delivered within 2 hours. Customer service was incredibly helpful in answering questions about custom specifications. Highly recommend Syntex Store!",
    date: "July 12, 2026"
  },
  {
    id: "test-2",
    userName: "David K. Chen",
    userAvatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80",
    rating: 5,
    comment: "I purchased the Air Max Plus OG shoes and the premium quality is unparalleled. The order process was frictionless and return policy is super straightforward.",
    date: "July 08, 2026"
  },
  {
    id: "test-3",
    ...
    rating: 5,
    comment: "Syntex Store's clean, premium interface makes it so easy to compare electronics. The customer service support answered my questions late at night in minutes.",
    date: "June 28, 2026"
  }
];
